...
typedef int (WINAPI* _ProcessPanelEventWrap)(struct WrapPluginInfo* wpi, const struct ProcessPanelEventInfo *Info);
typedef int (WINAPI* _ProcessHostFileWrap)(struct WrapPluginInfo* wpi, const ProcessHostFileInfo *Info);
typedef int (WINAPI* _ProcessPanelInputWrap)(struct WrapPluginInfo* wpi, const struct ProcessPanelInputInfo *Rec);
typedef int (WINAPI* _ProcessConsoleInputWrap)(struct WrapPluginInfo* wpi, struct ProcessConsoleInputInfo *Info);
typedef int (WINAPI* _ProcessSynchroEventWrap)(struct WrapPluginInfo* wpi, const struct ProcessSynchroEventInfo *Info);
typedef int (WINAPI* _ProcessViewerEventWrap)(struct WrapPluginInfo* wpi, const struct ProcessViewerEventInfo *Info);
...
struct Far3WrapFunctions
{
	...
	_ProcessPanelEventWrap ProcessPanelEventWrap;
