...
If you want to type in Far CommandLine - press Alt+«letter». After first symbol (when CommandLine is not empty) you may release Alt.
...
==Configuration==
Use Plugin.Call("9d5d070e-42f3-4a10-82e3-b3c74830705b",Cmd) to control plugin
Where Cmd is bitmask
