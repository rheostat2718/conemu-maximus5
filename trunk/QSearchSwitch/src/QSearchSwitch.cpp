...
const wchar_t* gsPluginName = L"QSearch switch";
...
void WINAPI GetPluginInfoW(struct PluginInfo *pi)
{
    ...
    static const wchar_t *pszMenu[1];
    pszMenu[0] = gsPluginName;
	pi->PluginConfig.Guids = &guid_QSearchSwitch;
...
{
	psi.ShowHelp(psi.ModuleName, NULL, FHELP_SELFHELP|FHELP_USECONTENTS);
	return TRUE;
}
