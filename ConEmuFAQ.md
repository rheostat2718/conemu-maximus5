...
A. For details, see here: [Certificate installation](Certificate.md)
...
A. Screenshots and some explanations can be seen/read here: [Issue 527](https://code.google.com/p/conemu-maximus5/issues/detail?id=527).
